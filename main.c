...
int main()
{
    ...
    // ft_printf("%c |\t\n", 'a');
    // ft_printf("%s\n", "123");
    // ft_printf("{color}bonus color : {RED}%d seul la reponse est {RED}rouge{reset} ! {GREEN}Incroyable !{reset} mais je mets {nimporte quoi} et {{red}avec{reset}} ", 123);
    // ft_printf("bonus {prout}color : {RED}%d test {Yellow}ca marche{RESET} ???\n", 123);
    // ft_printf("test %%\n");
